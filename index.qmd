...
Il **collettivo HQ** (Holy Quest) è un gruppo informale nato nella parrocchia Tre Santi di Bolzano e formatosi durante gli incontri di catechismo, qualche pizzata e la frequentazione della messa domenicale.

Attualmente è composto da adolescenti e giovani under 25.

- Il corto *Il trattato di Bolzano*, è il nostro primo cortometraggio a partecipare a un concorso nazionale (marzo 2026).

- Il corto *Biblio Vision*, è il nostro secondo cortometraggio (aprile 2026).

- Recentemente abbiamo realizzato un terzo cortometraggio *La bella addormentata* (maggio 2026).
...
2.  **l'Azione Cattolica (Diocesi BZ-BRESS)**: ci consente di noleggiare l'attrezzatura audiovisiva;

## Sostienici

Ci piacerebbe dedicarci a **progetti più ambiziosi** per coinvolgere la comunità, il quartiere e sensibilizzare la collettività su temi importanti.
